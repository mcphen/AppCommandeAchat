...
const slidesAdmin: Slide[] = [
    ...
    },
    {
        ...
        body: 'Commencez par créer vos sociétés ou entités, puis invitez vos utilisateurs et assignez-leur un rôle (demandeur, validateur).',
        tip: 'Menu Administration → Sociétés, puis Utilisateurs.',
        action: { label: 'Gérer les sociétés', href: '/admin/boutiques' },
    },
    {
        icon: CheckCircle2,
    ...
    },
    {
        ...
        body: 'Définissez des enveloppes budgétaires par société, par catégorie ou les deux. AchatPro vous alerte automatiquement à 80% de consommation et bloque les dépassements.',
    ...
    },
    {
        ...
        body: 'Suivez les dépenses par société, les délais de validation, le top fournisseurs. À chaque BC confirmé, les écritures OHADA sont générées automatiquement et exportables vers Sage, Odoo ou Epegase.',
