...
<table style="width:100%; border-collapse:collapse; margin-top:38px;">
    ...
    <tr>
        @foreach($sigCols as $col)
        <td style="width:{{ $colPct }}%; text-align:center; vertical-align:bottom; border-top:1px solid #bbb; padding-top:8px; height:165px;">
            @if($col['img'])
                <img src="{{ $col['img'] }}" style="max-height:125px; max-width:200px; object-fit:contain; display:block; margin:0 auto 4px;" />
            @endif
            @if($col['name'])
